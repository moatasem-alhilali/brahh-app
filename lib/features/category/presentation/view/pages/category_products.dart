...
class CategoryProducts extends StatefulWidget {
  CategoryProducts({Key? key, this.categoryName, this.categoryId})
      : super(key: key);
...
class _CategoryProductsState extends State<CategoryProducts> {
  ...
  getSubCategory() async {
    var res =
        await CategoryRepository().getCategories(parentId: widget.categoryId);
  ...
  fetchData() async {
    var productResponse = await ProductRepository().getCategoryProducts(
        id: widget.categoryId, page: _page, name: _searchKey);
                ...
                MaterialPageRoute(
                  builder: (context) {
                    return CategoryProducts(
                      categoryId: _subCategoryList[index].id,
                      categoryName: _subCategoryList[index].name,
                    );
                  },
                ),
              );
