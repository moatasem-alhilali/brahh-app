                  ...
                  _orderDetails!.shipping_address != null
                      ? Column(
                          ...
                          children: [
                            ...
                            Text(
                              "${app_mobile_language.$ == 'en' ? AppLocalizations.of(context)!.country_ucf : "الدولة"}: ${_orderDetails!.shipping_address!.country}",
                              maxLines: 3,
                              style: TextStyle(
                                color: MyTheme.grey_153,
                              ),
                            ...
                            Text(
                              "${app_mobile_language.$ == 'en' ? AppLocalizations.of(context)!.state_ucf : "المديريه"}: ${_orderDetails!.shipping_address!.state}",
                              maxLines: 3,
                              style: TextStyle(
                                color: MyTheme.grey_153,
                              ),
